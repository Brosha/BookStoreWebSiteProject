	...
	<div align="center">
			...
			<table class="form">
				...
				<tr>
					...
					<td align="left"><input type="text" id="headline" name="headline"
						size="60" value="${review.headline}" /></td>
				...
				<tr>
					...
					<td align="left">
						<textarea rows="5" cols="70" id="comment" name="comment">${review.headline}</textarea>
